...
procedure exercise7 is
    ...
    protected body Transaction_Manager is
        ...
        begin
            ...
            ------------------------------------------
            if Finished'Count = N-1 then -- First participant enters
                Finished_Gate_Open := True;
                Should_Commit := not Aborted;
            elsif Finished'Count = 0 then -- Last participant enters
    ...
    begin
        -------------------------------------------
        -- PART 1: Create the transaction work here (COMPLETED)
        -------------------------------------------
        -- Faulty behaviour
